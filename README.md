...
same classes. The repository's
`docs/journal/2026-09-08-the-mork-pin-advanced.md` records both pairs,
every original row's change and the controls. The simpler
